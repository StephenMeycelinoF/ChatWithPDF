...
// gsutil cors set cors.json gs://chat-with-pdf-d4767.appspot.com
// go here >>> https://console.cloud.google.com/
// create new file in editor call cors.json
// run >>> gsutil cors set cors.json gs://chat-with-pdf-d4767.appspot.com
